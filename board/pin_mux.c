...
- pin_list:
  ...
  - {pin_num: K16, peripheral: LPUART10, signal: TXD, pin_signal: GPIO_AD_32}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
- pin_list:
  ...
  - {pin_num: M3, peripheral: SAI2, signal: sai_rx_data, pin_signal: GPIO_EMC_B2_07}
...
void BOARD_InitM2CodecPins(void) {
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_EMC_B2_07_SAI2_RX_DATA,     /* GPIO_EMC_B2_07 is configured as SAI2_RX_DATA */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
